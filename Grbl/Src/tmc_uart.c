...
#if TRINAMIC_UART_ENABLE && (defined(BOARD_BTT_SKR_PRO_1_1) || defined(BOARD_BTT_SKR_20) || defined(BOARD_BTT_SKR_20_DAC))
...
static inline void setTX ()
{
    ...
    GPIO_PinInit(active_uart->port, &GPIO_InitStruct);
