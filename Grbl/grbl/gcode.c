...
status_code_t gc_execute_block(char *block)
{
    ...
    while ((letter = block[char_counter++]) != '\0')
    { // Loop until no more g-code words in block.
        ...
        case 'G': // Determine 'G' command and its modal group
            ...
            default:
                FAIL(Status_GcodeUnsupportedCommand); // [Unsupported G command]
            }                                         // end G-value switch
    ...
    */
    ...
    else if (gc_block.modal.feed_mode == FeedMode_InverseTime)
    { // = G93
    ...
    */
    ...
    default:
        ...
        if (axis_words.mask && axis_command != AxisCommand_ToolLengthOffset)
        ...
        else
        {
            ...
            if (gc_block.modal.canned_cycle_active)
            {
                ...
                case MotionMode_CcwArc:
                    ...
                    { // Arc Center Format Offset Mode 已知IJK求半径
