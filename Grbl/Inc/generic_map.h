...
#define X_STEP_PORT             GPIO3
#define Y_STEP_PORT             GPIO3
#define Z_STEP_PORT             GPIO1
...
#define X_DIRECTION_PORT		GPIO3
#define Y_DIRECTION_PORT		GPIO3
#define Z_DIRECTION_PORT		GPIO1
